import AppThemeMap from "../type/AppThemeMap";
...
const appTheme: AppThemeMap = {
    ...
    blue: {
        ...
        FollowButtonStyle: {
            backgroundColor: (followed: boolean) =>
                followed ? 'lightgray' : 'dodgerblue',
    ...
    black: {
        ...
        PlayerStyle: {
            ...
            indicatorColor: 'mediumvioletred',
            playerTextColor: (focused: boolean) =>
                focused ? 'mediumvioletred' : 'white',
        },
        FollowButtonStyle: {
            backgroundColor: (followed: boolean) =>
                followed ? 'lightgray' : 'mediumvioletred',
            rippleColor: 'grey',
            textColor: (followed: boolean) => (followed ? 'gray' : 'white'),
        },
        RoundButtonStyle: {
